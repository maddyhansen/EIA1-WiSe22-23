...
(function (Aufgabe10) {
    ...
    let number = document.getElementById("number"); /*function that defines what number is*/
    ...
    let value = document.getElementById("new-task-submit"); /*function that defines what value is*/
    ...
    window.addEventListener('load', () => {
        ...
        const input = document.querySelector("#new-task-input"); /*What is the HTML input element? The <input> element is most commonly used for collecting and retrieving user data from a web form. It's where users enter their data. It's nested inside the <form> element and it's a self closing element. This means it does not require a closing tag.*/
